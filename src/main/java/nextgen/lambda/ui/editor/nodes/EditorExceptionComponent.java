...
public class EditorExceptionComponent extends javax.swing.JPanel {

   private final Throwable model;
   private final nextgen.lambda.ui.editor.Editor editor;

   public EditorExceptionComponent(nextgen.lambda.ui.editor.Editor editor, Throwable model) {
